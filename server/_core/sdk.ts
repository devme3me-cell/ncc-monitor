...
class SDKServer {
  ...
  async verifySession(
    ...
    // Special bypass for test user in sandbox environment
    if (cookieValue === "local_demo_user") {
      console.log("[Auth] Bypass verification for local_demo_user");
      return {
  ...
  async authenticateRequest(req: Request): Promise<User> {
    ...
    if (sessionUserId === "local_demo_user") {
      return {
        id: 999,
        openId: "local_demo_user",
        name: "Demo User",
